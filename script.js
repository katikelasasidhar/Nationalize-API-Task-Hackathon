...
//Creating inner container to hold searchcontainer and reset button
let innercontainer=document.createElement('div');
innercontainer.setAttribute('class','innercontainer');
innercontainer.classList.add("container");
//Creating searchcontainer to hold input and button
let searchContainer=document.createElement('div');
searchContainer.setAttribute('class','search');
searchContainer.innerHTML=`
<input type="text" class="form-control col-4" id="inputText" placeholder="Search Me with valid known names ">
...
reset.innerHTML=`<button  onclick="resetPage()" class="btn btn-danger resetBtn col-2">Reset</button>`;
reset.classList.add("col-12")
//appending things
innercontainer.append(searchContainer,reset);
...
let countryname1,countryname2,nationality1,nationality2;
...
async function search(){
    ...
    try{
        ...
        alert("Please Enter Valid known First Name Like(sasi,john,yusuf,joseph)");
        resetPage();
    }
}
//here displayData function creating two cards
 function  displayData(values){
     //storing isocodes and probability values from API data
    let iso1=values.country[0].country_id;
    let iso2=values.country[1].country_id;
    let probability1=values.country[0].probability;
    let probability2=values.country[1].probability;
//getting country names and nationality from countrylist using ISO code
    for(let country of countrylist ){
        if(country.alpha_2_code==iso1){
          countryname1=  country.en_short_name;
          nationality1=country.nationality;
        }
        if(country.alpha_2_code==iso2){
            countryname2=  country.en_short_name;
            nationality2=country.nationality;
          }
    }
    //Creating card1 with country flag at top and country name and nationality ,probability
        ...
        //getting image source from country flags.io site
        image1.src=`https://www.countryflags.io/${iso1}/flat/64.png`;
        var body1=document.createElement('div');
         ...
         title1.innerHTML="Country :"+countryname1;
         var title2=document.createElement('h4');
         title2.setAttribute('class','card-title');
         title2.innerHTML="Nationality:"+nationality1;
         var title3=document.createElement('h5');
         title3.setAttribute('class','card-title');
         title3.innerHTML="Probability:"+probability1;
         body1.append(title1,title2,title3);
         card1.append(image1,body1);
 ...
 //Creating card2 with country flag at top and country name and nationality ,probability
         ...
         //getting image source from country flags.io site
         image2.src=`https://www.countryflags.io/${iso2}/flat/64.png`;
         var body2=document.createElement('div');
          body2.setAttribute('class','card-body');
          var title4=document.createElement('h4');
          title4.setAttribute('class','card-title');
          title4.innerHTML="Country :"+countryname2;
          var title5=document.createElement('h4');
          title5.setAttribute('class','card-title');
          title5.innerHTML="Nationality:"+nationality2;
          var title6=document.createElement('h5');
          title6.setAttribute('class','card-title');
          title6.innerHTML="Probability:"+probability2;
          body2.append(title4,title5,title6);
          card2.append(image2,body2);
